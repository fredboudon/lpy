...
#define MATCHING(func)                                                                      \
	...
	{                                                                                       \
		...
		if (st.check())                                                                     \
			p = ParamModule::PatternModule(st());                                           \
		else                                                                                \
		{                                                                                   \
...
void export_Module()
{
	...
	class_<Module>("Module", init<const std::string &>("Module(name)"))
		.enable_pickling()
	...
	{
		scope in_mod = class_<ParamModule, bases<Module>>("ParamModule", init<const std::string &>("ParamModule(name[,args])"))
						   .enable_pickling()
						   ...
						   //	.def("match",  &match)
						   .def("match", (bool (ParamModule::*)(const std::string &, size_t) const) & ParamModule::match)
